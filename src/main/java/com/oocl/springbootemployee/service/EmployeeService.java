...
import com.oocl.springbootemployee.exception.EmployeeNotExistException;
...
public class EmployeeService {
    ...
    public Employee create(Employee employee) {
        if (employee.getAge() < 18 || employee.getAge() > 65) {
            throw new EmployeeAgeNotValidException("Employee age is not valid");
        }

        if (employee.getAge() > 30 && employee.getSalary() < 20000) {
            throw new EmployeeSalaryNotValidException("Employee salary is not valid");
        }
